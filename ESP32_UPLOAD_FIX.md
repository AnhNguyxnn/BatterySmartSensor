# Hướng dẫn Fix ESP32 Upload Issue

## 🎯 Vấn đề
ESP32 không thể upload firmware vì không ở chế độ download mode.

## ✅ Giải pháp

### **Phương pháp 1: Reset ESP32 về Download Mode**
...
### **Phương pháp 2: Upload với esptool trực tiếp**
...
#### **Bước 2: Upload với baud rate thấp**
```bash
# Upload với baud rate thấp
pio run -t upload -e esp32dev --upload-port /dev/ttyUSB0 --upload-speed 115200
```
...
# PlatformIO upload with low baud rate
pio run -t upload -e esp32dev --upload-port /dev/ttyUSB0 --upload-speed 115200
