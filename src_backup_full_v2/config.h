...
// Cấu hình WiFi
#define WIFI_SSID "AnhNguyxn"
#define WIFI_PASSWORD "Tuananh14122009@"
...
#define APPLICATION_KEY "battery_monitor_2024_secure_key"  // API key để xác thực

// HTTPS tắt → không cần CA

// Cấu hình GPIO Pins
#define TEMP_SENSOR_PIN 34        // DS18B20
#define SMOKE_SENSOR_PIN 36      // MQ2 (Analog) → ESP32 ADC1 GPIO36 (VP). Tránh ADC2 khi dùng WiFi
...
#define NTP_SYNC_INTERVAL 3600000 // Sync mỗi 1 giờ (3600000ms)
...
// Cấu hình preheat MQ2
#define MQ2_PREHEAT_TIME_MS 300000  // 5 phút preheat (300000ms)
#define MQ2_STABLE_THRESHOLD 50      // ngưỡng ổn định cho preheat
